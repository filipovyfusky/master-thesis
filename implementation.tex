...
Caffe is available as a source code and one therefore needs to compile it on the target platform. For this, several steps need to be taken to ensure that all libraries are available during the build.
