...
\autor{}{Filip Špila}{}  % Jméno autora, 
...
\nazev{Návrh konstrukce a řízení nestabilního robota se sférickou základnou} 
  % Ručně můžete dlouhý text zalomit pomocí " \break "
\ennazev{Design of the construction and control algorithm for an unstable robot \break with spherical base} 
  % Ručně můžete dlouhý text zalomit pomocí " \break "

%vedouci prace
\vedouci{Ing.}{Tomáš Spáčil}{}
\citacevedouci{Vedoucí  Ing. Tomáš Spáčil.} % Označení vedoucího práce pro citaci záv. práce. Musí být ukončeno tečkou.
